	...
	<div class="box-body">
		...
		<div class="row">
	        <div class="col-xs-3">
		        ...
		        <div class="form-group has-feedback">
		            <input type="text" id="documento_identidad" name="documento_identidad" class="form-control" placeholder="Documento de identidad" value="@if(isset($empresas)) {{$empresas->empresaNIT}} @endif" disabled>
		        </div>
		    </div>
		    <div class="col-xs-3">
	    ...
	    <div class="row">
		    ...
		    <div class="col-xs-3">
		        ...
		        <div class="form-group has-feedback">
		            <select name="departamento_empresa" id="departamento_empresa" class="form-control select2" type="text">
		            	<option value="0">Seleccione una opción</option>
		    ...
		    <div class="col-xs-3">
		        ...
		        <div class="form-group has-feedback">
		            <select name="municipio_empresa" id="municipio_empresa" class="form-control select2" type="text" disabled>
		            	<option value="0">Seleccione una opción</option>
		            </select>
		        </div>
		    </div>
