...
use App\Http\Requests\Admin\Secciones\UpdateSeccionRequest;
...
class SeccionController extends Controller
{
     ...
     * @return \Illuminate\Http\RedirectResponse
     */
    public function update(UpdateSeccionRequest $request, TipoDiagnostico $diagnostico, SeccionPregunta $seccione)
    {
        $seccione->seccion_preguntaNOMBRE = $request->input('nombre_seccion');
        $seccione->seccion_preguntaPESO = $request->input('peso_seccion');
